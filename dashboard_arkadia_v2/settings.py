"""
Django settings for dashboard_arkadia_v2 project.
...
WSGI_APPLICATION = 'dashboard_arkadia_v2.wsgi.application'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'dashboard_arkadia_v2/static')]
